...
#define CUSTOM_USER_MENUS
  ...
  #define USER_DESC_1 "Fan Board On"
  #define USER_GCODE_1 "M106 P1 T2"

  #define USER_DESC_2 "Fan Board Off"
  #define USER_GCODE_2 "M107 P1"

  #define USER_DESC_3 "Save Setting"
